...
```bash
warm-up-cloudfront-from-s3$ sam build
```
...
```bash
warm-up-cloudfront-from-s3$ cd functions/<function-name>/
...
```bash
aws cloudformation delete-stack --stack-name warm-up-cloudfront-from-s3
```
